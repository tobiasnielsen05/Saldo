    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card text-white <?php echo $cardClass; ?> mb-4 mx-auto">
                ...
                <div class="card-body">
                    <h4 class="card-title fw-semibold"><?php echo number_format($available, 2, ',', '.'); ?>,- DKK</h4>
                </div>
            </div>
        </div>
        <div class="col-12">
            ...
            <div class="card bg-light mb-3 mx-auto">
                <div class="card-header fw-bold">Detaljer</div>
                <div class="card-body">
                    <p class="card-text"><strong>Indkomst:</strong> <?php echo number_format($incomeTotal, 2, ',', '.'); ?> kr</p>
                    <p class="card-text"><strong>Udgifter:</strong> -<?php echo number_format($expenseTotal, 2, ',', '.'); ?> kr</p>
                </div>
            </div>
        </div>
        <div class="col-12 mt-4 text-center">
            <a class="btn btn-knapfarve text-secondary fw-bold p-2" href="index.php">Tilføj indkomst/udgifter</a>
        </div>
    </div>
</div>
