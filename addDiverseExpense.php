...
<head>
    ...
    <title>Tilføj udgift / Saldo</title>
...
<div class="container mt-3">
    <form action="addDiverseExpense.php" method="post">
        <div class="row g-3">
            <div class="col-12 col-md-4">
                <label for="exAmount" class="form-label">Pris</label>
                <input type="number" step="0.01" class="form-control" id="exAmount" name="data[exAmount]" placeholder="Skriv prisen på udgiften her" value="">
            </div>
            <div class="col-12 col-md-4">
                <label for="exName" class="form-label">Udgift</label>
                <input type="text" class="form-control" id="exName" name="data[exName]" placeholder="F.eks. forsikring, internet, fagforening osv." value="">
            </div>
            <div class="col-12 col-md-4">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary">Tilføj udgift</button>
            </div>
        </div>
    </form>
</div>
